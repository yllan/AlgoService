...
/* 
 Allocates compressed column storage for AA^T, where A and A^T are input in compressed column
 format, and fills in values of col_ptr and row_ind. Each column must be in sorted order in input matrices.
 Matrix is output with each column sorted
...
public class ADAT {
  ...
  /* Computes ADA^T, where D is a diiiiiiigonal matrix. This function can be called repeatedly
   to update ADA^T for fixed A
   */
